...
namespace OnlineShopping.DAL
{
    ...
    public partial class Online_ShoppingEntities : DbContext
    {
        ...
        public virtual ObjectResult<USP_Search1_Result> USP_Search1(string searchKey)
        {
            var searchKeyParameter = searchKey != null ?
                new ObjectParameter("searchKey", searchKey) :
                new ObjectParameter("searchKey", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Search1_Result>("USP_Search1", searchKeyParameter);
        }
    }
}
